...
class TokenTaggingRegressorMLE(LightningModule):
    ...
    def on_train_epoch_end(self):
        ...
        np.save(f"./lossesr/train_sum{self.epoch_num}.npy", self.train_loss_metrics.loss_sum)
        np.save(f"./lossesr/train_mean{self.epoch_num}.npy", self.train_loss_metrics.loss_mean)
        np.save(f"./lossesr/train_stdev{self.epoch_num}.npy", self.train_loss_metrics.loss_stdev)
        np.save(f"./lossesr/train_stderr{self.epoch_num}.npy", self.train_loss_metrics.loss_stderr)
        np.save(f"./lossesr/train_freqs{self.epoch_num}.npy", self.train_loss_metrics.freqs_sum)        
    ...
    def on_validation_epoch_end(self):
        ...
        np.save(f"./lossesr/val_sum{self.epoch_num}.npy", self.val_loss_metrics.loss_sum)
        np.save(f"./lossesr/val_mean{self.epoch_num}.npy", self.val_loss_metrics.loss_mean)
        np.save(f"./lossesr/val_stdev{self.epoch_num}.npy", self.val_loss_metrics.loss_stdev)
        np.save(f"./lossesr/val_stderr{self.epoch_num}.npy", self.val_loss_metrics.loss_stderr)
        np.save(f"./lossesr/val_freqs{self.epoch_num}.npy", self.val_loss_metrics.freqs_sum)
    ...
    def on_test_epoch_end(self):
        ...
        np.save(f"./lossesr/test_sum.npy", self.test_loss_metrics.loss_sum)
        np.save(f"./lossesr/test_mean.npy", self.test_loss_metrics.loss_mean)
        np.save(f"./lossesr/test_stdev.npy", self.test_loss_metrics.loss_stdev)
        np.save(f"./lossesr/test_stderr.npy", self.test_loss_metrics.loss_stderr)
        np.save(f"./lossesr/test_freqs.npy", self.test_loss_metrics.freqs_sum)
