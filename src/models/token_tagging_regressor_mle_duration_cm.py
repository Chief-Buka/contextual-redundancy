...
class TokenTaggingRegressorMLE(LightningModule):
    ...
    def on_train_epoch_end(self):
        ...
        np.save(f"./losses_duration/train_sum{self.epoch_num}.npy", self.train_loss_metrics.loss_sum)
        np.save(f"./losses_duration/train_stderr{self.epoch_num}.npy", self.train_loss_metrics.loss_stderr)
        np.save(f"./losses_duration/train_freqs{self.epoch_num}.npy", self.train_loss_metrics.freqs_sum)
    ...
    def on_validation_epoch_end(self):
        ...
        np.save(f"./losses_duration/val_sum{self.epoch_num}.npy", self.val_loss_metrics.loss_sum)
        np.save(f"./losses_duration/val_stderr{self.epoch_num}.npy", self.val_loss_metrics.loss_stderr)
        np.save(f"./losses_duration/val_freqs{self.epoch_num}.npy", self.val_loss_metrics.freqs_sum)
    ...
    def on_test_epoch_end(self):
        ...
        np.save(f"./losses_duration/test_sum.npy", self.test_loss_metrics.loss_sum)
        np.save(f"./losses_duration/test_stderr.npy", self.test_loss_metrics.loss_stderr)
        np.save(f"./losses_duration/test_freqs.npy", self.test_loss_metrics.freqs_sum)
