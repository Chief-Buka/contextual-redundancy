...
class TokenTaggingRegressorMLE(LightningModule):
    ...
    def on_train_epoch_end(self):
        ...
        np.save(f"./losses/train_sum{self.epoch_num}.npy", self.train_loss_metrics.loss_sum)
        np.save(f"./losses/train_stderr{self.epoch_num}.npy", self.train_loss_metrics.loss_stderr)
        np.save(f"./losses/train_freqs{self.epoch_num}.npy", self.train_loss_metrics.freqs_sum)
    ...
    def on_validation_epoch_end(self):
        ...
        if self.epoch_num > 0:
            ...
            np.save(f"./losses/val_sum{self.epoch_num}.npy", self.val_loss_metrics.loss_sum)
            np.save(f"./losses/val_stderr{self.epoch_num}.npy", self.val_loss_metrics.loss_stderr)
            np.save(f"./losses/val_freqs{self.epoch_num}.npy", self.val_loss_metrics.freqs_sum)
