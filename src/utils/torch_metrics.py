...
class MeanMetricByPos(Metric):
    def __init__(self):
        super().__init__()
        self.add_state("sum", default=torch.zeros(10, 10), dist_reduce_fx=dist_reduce_custom)
        self.add_state("total", default=torch.zeros(10,10), dist_reduce_fx=dist_reduce_custom)
